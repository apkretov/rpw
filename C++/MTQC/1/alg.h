...
namespace mtqc {
	...
	public:
		...
		double lips_get(int intIdx) const; //TO DO: Rename it into setLips. //TO DO: Make these three functions private. //TO DO: Remove these functions and use cobjCandlesByIndexLips->getClose(intShift) directly to boost performance.
		...
		//KTB Switched off because shifting the time frame needs arranging a new chrTag for another time frame. bool time_frame_shift(ENUM_TIMEFRAMES intTimeFrame) override final;
		bool signalGet();
