...
class CeilingFanLowCommand final : public Command {
	CeilingFan &ceilingFan_;
	int prevSpeed_; 
public:
	explicit CeilingFanLowCommand(CeilingFan &ceilingFan) : ceilingFan_(ceilingFan), prevSpeed_(0) {}
	void execute() override { ceilingFan_.low(); }
