...
CMainWnd::CMainWnd() {
	...
	Create(NULL, _T("Step11"), WS_OVERLAPPEDWINDOW, rectDefault, NULL, NULL); // Создать окно программы
...
void CMainWnd::OnPaint() {
	...
	dc.TextOut(500, 200, "TextOut Samples"); //Вывести строку.
	dc.SetPixel(500, 200, RGB(255, 0, 0)); //Вывести точку, смотрите внимательно, ну маленькая она и чем выше разрешение экрана, тем меньше.
	dc.Arc(200, 200, 100, 100, 400, 400, 10, 10); //Дуга окружности.
	dc.Chord(250, 250, 100, 100, 400, 400, 10, 10); //Замкнутая дуга.
	dc.Ellipse(450, 450, 50, 150); //Эллипс.
	dc.MoveTo(200, 200); //Линия.
	dc.LineTo(100, 100);
