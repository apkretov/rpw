...
LRESULT CALLBACK WndProc(HWND hwnd, UINT Message, WPARAM wParam, LPARAM lParam) {
	switch (Message) {
		case WM_CREATE: {
				...
				if (hIconSm) (hwnd, WM_SETICON, ICON_SMALL, (LPARAM)hIconSm);
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow) {
	...
	//ORIG hwnd = CreateWindowEx(WS_EX_CLIENTEDGE, g_szClassName, "A Menu #2", WS_OVERLAPPEDWINDOW, CW_USEDEFAULT, CW_USEDEFAULT, 600, 300, NULL, NULL, hInstance, NULL);
	hwnd = CreateWindowEx(WS_EX_CLIENTEDGE, g_szClassName, "02 menu_two.exe - A Menu #2", WS_OVERLAPPEDWINDOW, CW_USEDEFAULT, CW_USEDEFAULT, 600, 300, NULL, NULL, hInstance, NULL);
	if (hwnd == NULL)	{
