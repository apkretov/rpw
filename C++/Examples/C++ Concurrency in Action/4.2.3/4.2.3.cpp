...
#include "Listing 4.10.h" // Include the original code from the listing. The file must be included here after the types declared above.
...
3. Fulfilling the promise : Inside process_connections(specifically in Listing 4.10.h), when an outgoing_packet is found
