...
public:
	...
	explicit simple_future(shared_ptr<shared_state<T>> s) : state(move(s)) {}
	simple_future(const simple_future&) = delete;
	simple_future& operator=(const simple_future&) = delete;
	simple_future(simple_future&& other) noexcept : state(move(other.state)) {}
...
public:
	simple_future() = default;
	explicit simple_future(shared_ptr<shared_state<void>> s) : state(move(s)) {}
	simple_future(const simple_future&) = delete;
	simple_future& operator=(const simple_future&) = delete;
	simple_future(simple_future&& other) noexcept : state(move(other.state)) {}
