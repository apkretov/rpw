...
Also instead of the busy waiting (while (!done(connections)) in listing_4.10.h), would condition variables be more
  performant?
...
Comment 3.
 ...
 Would it be reasonable to split void process_connections(connection_set & connections) in @listing_4.10.h to have two
