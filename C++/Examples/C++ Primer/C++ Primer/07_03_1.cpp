...
char Screen__Member_Functions_of_Class_Screen::get(pos r, pos c) const { // declared as inline in the class
...
void Screen__mutable_Data_Members::some_member() const {
...
inline // we can specify inline on the definition //TEST!
Screen__Member_Functions_of_Class_Screen &Screen__Member_Functions_of_Class_Screen::move(pos r, pos c) {
