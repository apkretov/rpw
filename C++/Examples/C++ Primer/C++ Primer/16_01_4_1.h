...
#pragma region Member_Templates_of_Class_Templates
	template <typename It> Blob(It b, It e); //TEST!
#pragma endregion
...
#pragma region Member_Templates_of_Class_Templates
template <typename T> //TEST! //																																type parameter for the class
template <typename It> //TEST! //																																type parameter for the constructor
