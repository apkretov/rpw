...
int frame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	m_wndStatusBar.SetIndicators(mtqcMFC::indicators, sizeof(mtqcMFC::indicators)/sizeof(UINT));
...
BOOL frame::PreCreateWindow(CREATESTRUCT& cs) {
	...
	*/
	...
	//MFC application title @ https://stackoverflow.com/questions/23303358/mfc-application-title
	cs.style &= ~FWS_ADDTOTITLE;
	return CFrameWnd::PreCreateWindow(cs); // replace CFrameWndEx by CFrameWnd if your CMainFrame is based on CFrameWnd
}
