...
Begin VB.Form frmBrsShG 
   ...
   Begin MSComctlLib.ImageList ilsSgG 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmBrsShG.frx":106F
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmBrsShG.frx":18C1
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmBrsShG.frx":3523
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmBrsShG.frx":40D9
            Key             =   ""
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmBrsShG.frx":492B
            Key             =   ""
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmBrsShG.frx":517D
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin MSComctlLib.ImageList ilsFarms 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   2
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmBrsShG.frx":5B60
            Key             =   "Folder"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmBrsShG.frx":5CBA
            Key             =   "Folderop"
         EndProperty
      EndProperty
   End
   Begin TabDlg.SSTab tabFarms 
      ...
      TabPicture(0)   =   "frmBrsShG.frx":5E14
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "treFarms"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "Алфавиту"
      TabPicture(1)   =   "frmBrsShG.frx":5E30
...
On Error GoTo ErrHnd
   ...
   adoFarms.ConnectionString = gcnnConnServ.ConnectionString 'adoFarms & dbcFarms.
...
On Error GoTo ErrHnd
   ...
   If intLeng = gobFormtCtl.LengIDFarm Then 'Prevent
      strIDFarmPrev = strIDFarm 'Remember the farm.               'unnecessary operation.
...
' Sort the dgdShG grid's data source's recordset & refresh the control.
' Distinguish the data source by the calling form.
Private Sub SortShG()
On Error GoTo ErrHnd
   TblBrsOb.Sort DatLst.BoundText 'Sort.
...
On Error GoTo ErrHnd
   ...
   obTblBrs.Sel strIDFarm, lngDateDispMin, lngDateDispMax, chkFiltInven(0), _
      chkFiltInven(1), chkFiltInven(2), chkFiltInven(3), chkFiltInven(4), _
      chkFiltInven(5), chkFiltInven(6), chkFiltInven(7)
   Call SortShG 'Sort sheep/goats.
   Set dgdShG.DataSource = mobTblBrsShG 'Set data source.
...
On Error GoTo ErrHnd
   ...
   obTblBrs.Sel strIDFarm, lngDateDispMin, lngDateDispMax, chkFiltMat(0), _
      chkFiltMat(1), chkFiltMat(2), chkFiltMat(3)
   Call SortShG 'Sort sheep/goats.
   Set dgdShG.DataSource = mobTblBrsMat
...
On Error GoTo ErrHnd
   ...
   obTblBrs.Sel strIDFarm, lngDateDispMin, lngDateDispMax, chkFiltLmK(0), _
      chkFiltLmK(1), chkFiltLmK(2), chkFiltLmK(3), chkFiltLmK(4), chkFiltLmK(5), _
      chkFiltLmK(6), chkFiltLmK(7)
   Call SortShG 'Sort sheep/goats.
   Set dgdShG.DataSource = mobTblBrsLmK
...
On Error GoTo ErrHnd
   ...
   obTblBrs.Sel strIDFarm, lngDateDispMin, lngDateDispMax, chkFiltWtLmK(0), _
      chkFiltWtLmK(1), chkFiltWtLmK(2), chkFiltWtLmK(3)
   Call SortShG 'Sort sheep/goats.
   Set dgdShG.DataSource = mobTblBrsWtLmK
...
On Error GoTo ErrHnd
   ...
   obTblBrs.Sel strIDFarm, lngDateDispMin, lngDateDispMax, chkFiltWtWool(0), _
      chkFiltWtWool(1), chkFiltWtWool(2), chkFiltWtWool(3)
   Call SortShG 'Sort sheep/goats.
   Set dgdShG.DataSource = mobTblBrsWtWool
...
On Error GoTo ErrHnd
   ...
   obTblBrs.Sel strIDFarm, lngDateDispMin, lngDateDispMax, chkFiltAppr(0), _
      chkFiltAppr(1), chkFiltAppr(2), chkFiltAppr(3)
   Call SortShG 'Sort sheep/goats.
   Set dgdShG.DataSource = mobTblBrsAppr
...
On Error GoTo ErrHnd
   Const lngKeptOn As Long = 0 'Kept-ShG-On days value.
   Const lngKeptOff As Long = 1 'Kept-ShG-Off days value.
   Const lngDispOff As Long = 0 'Disposed-ShG-Off days value.
