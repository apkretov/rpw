...
Private Sub InitCtl()
On Error GoTo ErrHnd
   adoFarmBrs.ConnectionString = gcnnConn.ConnectionString 'adoFarmBrs & dblFarmBrs.
   With dblFarmBrs
      Set .RowSource = adoFarmBrs
      .BoundColumn = "IDFarm"
      .ListField = "IDFarm"
   End With
   adoTwnVll.ConnectionString = gcnnConn.ConnectionString 'adoTwnVll & dbcTwnVll.
   With dbcTwnVll
      Set .RowSource = adoTwnVll
      .BoundColumn = "IDTownVill"
      .ListField = "TownVill"
   End With
   adoPersFarm.ConnectionString = gcnnConn.ConnectionString 'adoPersFarm &
   With dbcPersFarm                                             'dbcPersFarm.
      Set .RowSource = adoPersFarm
      .BoundColumn = "IDPers"
      .ListField = "Nam"
   End With
   adoPersCont.ConnectionString = gcnnConn.ConnectionString 'adoPersCont &
   With dbcPersCont                                             'dbcPersCont.
      Set .RowSource = adoPersCont
      .BoundColumn = "IDPers"
      .ListField = "Nam"
   End With
   adoShG.ConnectionString = gcnnConn.ConnectionString 'adoShG & dgdShG.
   adoShGBorn.ConnectionString = gcnnConn.ConnectionString 'adoShGBorn & dgdShGBorn.
   adoShGTrans.ConnectionString = gcnnConn.ConnectionString 'adoShGTrans &
...
On Error GoTo ErrHnd
   With mobUtilDatFrm
      .GridRecSrc adoShG, "SELECT IDSheepGoat AS [Находящиеся на ферме] FROM " & _
         "SheepGoat WHERE (IDFarm = """ & mobDatFrm.IDFrm & """)", dgdShG
      .GridRecSrc adoShGBorn, "SELECT IDSheepGoat AS [Рождённые на ферме] FROM " & _
         "SheepGoat WHERE (IDFarmBirth = """ & mobDatFrm.IDFrm & """)", dgdShGBorn
      .GridRecSrc adoShGTrans, "SELECT IDSheepGoat AS [Проданные на ферму], " & _
         "DateTrans AS [Дата племпродажи] FROM TransFarm WHERE (IDFarm = """ & _
         mobDatFrm.IDFrm & """)", dgdShGTrans
   End With
Exit Sub
ErrHnd:
MsgBox Err.Description
