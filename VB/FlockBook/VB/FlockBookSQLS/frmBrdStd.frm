...
Begin VB.Form frmBrdStd 
   ...
   Begin TabDlg.SSTab tabBrdStd 
      ...
      Tab(0).Control(0)=   "fraSelIndx(0)"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).Control(1)=   "fraCompClass(0)"
...
'      adoBrdBrs.Refresh 'Refresh the list of breed ID's, if changed.
   End If
Exit Sub
ErrHnd:
   MsgBox Err.Description
...
Private Sub InitCtl()
On Error GoTo ErrHnd
   adoBrdBrs.ConnectionString = gcnnConnServ.ConnectionString 'ado's ConnectionString's.
...
On Error GoTo ErrHnd
   ...
   For Each adoCtl In obColAdo
      adoCtl.ConnectionString = gcnnConnServ.ConnectionString
   Next
Exit Sub
ErrHnd:
MsgBox Err.Description
