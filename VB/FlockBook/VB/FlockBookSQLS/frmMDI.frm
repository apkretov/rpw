...
Begin VB.MDIForm frmMDI 
   ...
   Begin VB.Menu mnuSetng 
      ...
      End
      Begin VB.Menu mnuSetngDBRestr 
         Caption         =   "Cоздание/восстановление базы данных..."
      End
      Begin VB.Menu mnuSetngExport 
...
On Error GoTo ErrHnd
   ...
   If gcnnConnServ.State = adStateOpen Then If Not obUtilDB.Busy Then obUtilDB.DropTblRpt
   Set gcnnConnServ = Nothing 'Destroy globals.
...
' Restore a DB.
Private Sub mnuSetngDBRestr_Click()
On Error GoTo ErrHnd
   frmDBRestr.Show vbModal
Exit Sub
ErrHnd:
MsgBox Err.Description
End Sub
...
' Export data.
Private Sub mnuSetngExport_Click()
On Error GoTo ErrHnd
   Dim obUtilDB As UtilDB
   Set obUtilDB = New UtilDB
   obUtilDB.Export
...
On Error GoTo ErrHnd
   ...
   mfrmRptFarmDate.Show vbModal
'   frmRptFarmDate.Show vbModal
'   frmRptFarmDate.Idx = mfrmRptFarmDate.idxSumGenEval 'The report index.
Exit Sub
ErrHnd:
MsgBox Err.Description
End Sub
...
On Error GoTo ErrHnd
   ...
   mfrmRptFarmDate.Show vbModal
'   frmRptFarmDate.Show vbModal
'   frmRptFarmDate.Idx = mfrmRptFarmDate.idxSumPerform 'The report index.
Exit Sub
ErrHnd:
MsgBox Err.Description
End Sub
...
Rem Substitute likewise some timer-based procedures.
