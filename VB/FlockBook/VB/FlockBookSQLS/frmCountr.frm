...
Private Sub InitCtl()
On Error GoTo ErrHnd
   adoCountrBrs.ConnectionString = gcnnConnServ.ConnectionString 'adoCountrBrs &
   With dblCountrBrs                                             'dblCountrBrs.
      Set .RowSource = adoCountrBrs
      .BoundColumn = "IDCountry"
      .ListField = "Country"
   End With
   adoObl.ConnectionString = gcnnConnServ.ConnectionString 'adoObl & dgdObl.
...
On Error GoTo ErrHnd
   mobUtilDatFrm.GridRecSrc adoObl, "spSelect_Oblasts_Grid('" & mobDatFrm.IDFrm & "')", _
      dgdObl
Exit Sub
ErrHnd:
MsgBox Err.Description
