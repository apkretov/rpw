...
'   mobUtilDatFrm.Ok_Click LoadResString(284)
Exit Sub
ErrHnd:
MsgBox Err.Description
End Sub
...
Private Sub InitCtl()
On Error GoTo ErrHnd
   adoDefctBrs.ConnectionString = gcnnConnServ.ConnectionString 'adoDefctBrs & dblDefctBrs.
   With dblDefctBrs
      Set .RowSource = adoDefctBrs
      .BoundColumn = "IDDefect"
      .ListField = "Defect"
   End With
   adoShG.ConnectionString = gcnnConnServ.ConnectionString 'Set the data source for
...
On Error GoTo ErrHnd
   mobUtilDatFrm.GridRecSrc adoShG, "spSelect_Appraisal_Grid('" & mobDatFrm.IDFrm & _
      "')", dgdShG
Exit Sub
ErrHnd:
MsgBox Err.Description
